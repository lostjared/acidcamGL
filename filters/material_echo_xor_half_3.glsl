...
void main(void)
{
    ...
    vec4 color4 = (0.5 * texture(samp, tc/6)) + (0.5 * texture(mat_samp, tc/6));
    
    color2 = xor_RGB(color, color2);
    color3 = xor_RGB(color, color3);
    color4 = xor_RGB(color, color4);
    
    color = (color * 0.6) + (color2 * 0.2) + (color3 * 0.2) + (color4 * 0.2);
}
